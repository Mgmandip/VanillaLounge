    ...
    <div className="flex pt-7 pl-7 gap-6 text-[#063C4A]">
      ...
      <div className="flex-1 pr-7">
        ...
        <div className="pt-3 border rounded-md border-gray-300 bg-white">
          ...
          <div className="flex flex-col sm:flex-row items-start justify-between gap-4 px-5 space-y-3">
            <div>
              <h1 className="font-semibold text-sm">Access Level</h1>
              <h1 className="text-[#878787] text-sm">{profile.Department}</h1>
            </div>
