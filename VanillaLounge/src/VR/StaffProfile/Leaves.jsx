            ...
            <table className="border-collapse border-2 border-none w-full">
              <thead className="bg-[#FAFAFA]">
                <tr className="text-left text-sm p-3">
                  ...
                  <th className="p-2">Leave Duration</th>
                  <th className="p-2">Leave Category</th>
              ...
              <tbody>
                {documents.map((doc, index) => (
                  ...
                  >
                    ...
                    <td className="pl-2 pt-3 pb-3">{doc.leavetype}</td>
                    <td className="pl-2 pt-3 pb-3">{doc.leaveduration}</td>
                    <td className="pl-2 pt-3 pb-3">{doc.leavecategory}</td>
                    <td className="pl-2 pt-3 pb-3">{doc.status}</td>
                    <td className="p-2 pt-3 pb-3 text-[#063C4A] cursor-pointer">
                      <HiPencil />
                    </td>
                  </tr>
                ))}
