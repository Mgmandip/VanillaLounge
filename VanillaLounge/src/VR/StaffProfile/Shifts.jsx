  ...
  const documents = [
    {
      ...
      role: "Chef",
      time: "6 am - 12:30 pm",
      shiftnote: "Reviewing staff availability and working hours",
    },
    {
      date: "2025/04/09",
      day: "Sunday",
          ...
          <div className="flex pr-8 justify-between">
            <div className="pl-6 w-full flex gap-2 justify-between">
              ...
              <div className="flex gap-2">
                ...
                <div className="flex items-center justify-center pl-4 h-10 px-4 border border-[#C2C2C2] rounded-md text-xs shadow-md hover:bg-[#EBF2E4]">
                  <button className="flex gap-2 items-center">
            ...
            <table className="border-collapse border-2 border-none w-full">
              <thead className="bg-[#FAFAFA]">
                <tr className="text-left text-sm p-3">
                  ...
                  <th className="p-2">Shift Note</th>
                </tr>
              </thead>
              <tbody>
                {documents.map((doc, index) => (
                  ...
                  >
                    ...
                    <td className="pl-2 pt-3 pb-3">{doc.department}</td>
                    <td className="pl-2 pt-3 pb-3">{doc.role}</td>
                    <td className="pl-2 pt-3 pb-3">{doc.time}</td>
                    <td className="pl-2 pt-3 pb-3">{doc.shiftnote}</td>
                  </tr>
                ))}
              </tbody>
            </table>
